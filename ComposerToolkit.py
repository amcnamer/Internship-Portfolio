"""
For this assignment I wanted to create a composer toolkit program. My overall goal was to build it with modularity
in mind so that when I start adding things during the process and also later that the additions require
very little additional code which was my overall goal while creating this.
"""
